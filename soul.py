...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*FOR RESSELER SHIP DM @NSG_Rajesh:-*", parse_mode='Markdown')
        ...
        bot.reply_to(message, "*@NSG_Rajesh*", parse_mode='Markdown')
    else:
...
if __name__ == "__main__":
    ...
    logging.info("NSG_Rajesh SERVER RUNNING.....")
    while True:
        try:
